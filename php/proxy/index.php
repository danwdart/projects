...
curl_setopt($ch, CURLOPT_USERAGENT, "Bibud a2.1");
...
$output=preg_replace("/src=\w/i","src=http://localhost/proxy/?url=",$output);
 $output=preg_replace("/href=\w/i","href=http://localhost/proxy/?url=",$output);
 $output=preg_replace("/action=\w/i","action=http://localhost/proxy/?url=",$output);

 $output=preg_replace('/src="/i','src="http://localhost/proxy/?url=',$output);
 $output=preg_replace('/href="/i','href="http://localhost/proxy/?url=',$output);
 $output=preg_replace('/action="/i','action="http://localhost/proxy/?url=',$output);
