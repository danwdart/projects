...
let
  sources = {
    ...
    "nw-0.50.3" = {
      ...
      version = "0.50.3";
      src = fetchurl {
        url = "https://registry.npmjs.org/nw/-/nw-0.50.3.tgz";
        sha512 = "csc1+4QmaWxZ4wzcArSsH1xS4Qs/Delu85UQxfmfCLacsCyAZ+UkpZCw+wR4Uk2n4FcDAlId6XBr8sekQ5Pfjg==";
      };
    };
    "object-assign-4.1.1" = {
      name = "object-assign";
