...
(function() {
  ...
  Matrix = (function() {
    ...
    Matrix.prototype.mul = function(m2) {
      var intSum, lCol, n, rRow, resEls, _i, _j, _k, _ref, _ref1, _ref2;
      if (this.w !== m2.h) {
        throw new Error('Cannot multiply this matrix: ' + this.w + ' by ' + m2.h);
      }
      resEls = [];
      for (lCol = _i = 0, _ref = this.h - 1; 0 <= _ref ? _i <= _ref : _i >= _ref; lCol = 0 <= _ref ? ++_i : --_i) {
        for (rRow = _j = 0, _ref1 = m2.w - 1; 0 <= _ref1 ? _j <= _ref1 : _j >= _ref1; rRow = 0 <= _ref1 ? ++_j : --_j) {
          intSum = 0;
