...
let
  sources = {
    ...
    "cytoscape-3.17.1" = {
      ...
      version = "3.17.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/cytoscape/-/cytoscape-3.17.1.tgz";
        sha512 = "66jNdRnRxIS4IE+EOax6ElhQcwK8VHmcsbGtDJ4YeuDGLRr5HLotCgeTCAIzpYt6V9CuaTuvhkSkie83wUqhxg==";
      };
    };
    ...
    "typescript-4.2.0-dev.20210120" = {
      name = "typescript";
      packageName = "typescript";
      version = "4.2.0-dev.20210120";
      src = fetchurl {
        url = "https://registry.npmjs.org/typescript/-/typescript-4.2.0-dev.20210120.tgz";
        sha512 = "ko+8fE1gUb7LlcfZVodyMJ5ErCkucpQ3ydkMxLelzPC14LAY/RQ+846hRGAyUBLF22J4di+/y4bvGwzXC+6o1Q==";
      };
    };
    "unique-string-2.0.0" = {
      name = "unique-string";
  ...
  args = {
    ...
    dependencies = [
      ...
      sources."typescript-4.2.0-dev.20210120"
